...
import com.wqa.cems.constant.FileConstant;
import com.wqa.cems.exception.BusinessException;
import com.wqa.cems.manager.CosManager;
...
import com.wqa.cems.model.dto.file.UploadFileRequest;
import com.wqa.cems.model.entity.User;
import com.wqa.cems.model.enums.FileUploadBizEnum;
...
public class FileController {
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
            UploadFileRequest uploadFileRequest, HttpSession session) {
        ...
        try {
            ...
            log.info(FileConstant.COS_HOST + filepath);
            // 返回可访问地址

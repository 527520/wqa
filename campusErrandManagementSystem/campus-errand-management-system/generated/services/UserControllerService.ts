...
import type { BaseResponse_PageInfo_UserInfo_ } from "../models/BaseResponse_PageInfo_UserInfo_";
...
export class UserControllerService {
   ...
   * @returns BaseResponse_PageInfo_UserInfo_ OK
   * @returns any Created
   * @throws ApiError
   */
  public static listUserByPageUsingPost(
    userQueryRequest: UserQueryRequest
  ): CancelablePromise<BaseResponse_PageInfo_UserInfo_ | any> {
    return __request(OpenAPI, {
      method: "POST",
   ...
   * @throws ApiError
   */
  public static searchUserUsingPost(
